...
#define OLED_DC 5
#define OLED_CS 1
Adafruit_SH1106_jhh display(SCREEN_WIDTH, SCREEN_HEIGHT,
...
void setup()
{
    ...
    // set SPI object for Pico
    // See: https://arduino-pico.readthedocs.io/en/latest/spi.html
    // don't receive anything from a display // SPI.setRX(/**/);
    // CS handled in software // SPI.setCS(/**/);
    SPI.setSCK(OLED_CLK);
    SPI.setTX(OLED_MOSI);

    // boolean parameter hwCS is false because handling CS in software
    SPI.begin(false);
